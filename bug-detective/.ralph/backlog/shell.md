...
- [x] **SH-2 Desk hit-routing inconsistency** — `lampHit` cylinder tightened from 0.18r×1.05 @ y=0.55 to 0.13r×0.92 @ y=0.42 so its screen-space projection no longer bleeds over the envelope at typical camera angles. (+5) **[done iter-25]**
...
- [ ] **SH-10 Audio bed under the desk view** — soft ambient tone (typing/static) so silence between actions doesn't feel dead. (+1) **[deferred — needs audio asset; not engineering work]**
